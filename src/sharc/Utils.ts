...
import { AnimationCallback, PublicAnimationType } from './types/Animation.ts';
import { ColorType, PositionType, BoundsType, EasingType } from './types/Common.ts';
 ...
 */
export function Circle(x: number, y: number, radius: number, radiusY?: number): BoundsType {
 ...
 */
export function Center(x: number, y: number, width: number, height?: number): BoundsType {
 ...
 */
export function addCallback(value: number): Function {
 ...
 */
export function addXCallback(value: number): (property: PositionType) => PositionType {
 ...
 */
export function addYCallback(value: number): Function {
 ...
 */
export function addPositionCallback(x: number, y: number): Function {
...
export function Animate<props>(
    ...
    from: Exclude<props[keyof props], string | boolean | any[] | PositionType[]> | null, 
    to: Exclude<props[keyof props], string | boolean | any[] | PositionType[]> | AnimationCallback<Exclude<props[keyof props], string | boolean | any[] | PositionType[]>>, 
    duration: number = 60, 
    delay: number = 0, 
    easing: EasingType = Easing.LINEAR,
    name: string = '',
    details: (string|number)[] = []): PublicAnimationType<props> {
